...
export default function SellItem() {
  ...
  return (
    ...
    <div className='ml-4'><Link href='/'><span >Home</span></Link> / <Link href='/market'><span>Market</span></Link> / <Link href='/market/sell-item'><span  className="font-bold cursor-pointer">Sell Item</span></Link></div>

    <div className="bg-[rgb(55,62,77)] min-h-fit pb-10 mt-10">
    <p className="text-white text-lg text-center pt-2">What Do You Want To Sell?</p>
    <div className="pt-4 flex justify-center items-center gap-10">
          <div>
            <label className="text-white mr-2">Item</label>
            <input type="radio" name="calculatorType" value="item" onChange={handleRadioChange} />
          </div>
          <div>
            <label className="text-white mr-2">Refine</label>
            <input type="radio" name="calculatorType" value="refine" onChange={handleRadioChange} />
          </div>
        </div>
        {choose === "item" && (
          <>
