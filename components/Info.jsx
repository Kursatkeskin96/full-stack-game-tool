  ...
  return (
    ...
    <div className=''>
        ...
        <div className='lg:w-1/2 text-center flex flex-col justify-around gap-10 lg:gap-5 min-h-72'>
            ...
            <div><Link href='/guides'><button className='bg-orange-600 text-black w-40 p-1 rounded-md'>GUIDES</button></Link></div>
        </div>
    </div>
    ...
    <div className='flex my-20 justify-center items-center lg:gap-20 lg:max-w-[80%] max-w-[90%] mx-auto flex-wrap'>
        <div className='lg:w-1/2 text-center flex flex-col justify-around min-h-72 lg:gap-5'>
            ...
            <div><Link href='/profit-calculator/item-calculator'><button className='bg-orange-600 mb-8 lg:mb-0 text-black w-40 p-1 rounded-md'>CALCULATORS</button></Link></div>
        </div>
    ...
    <div className='flex flex-col justify-center items-center my-20 lg:my-0 gap-2 lg:gap-0 lg:max-w-[80%] max-w-[90%] mx-auto flex-wrap'>
        ...
        <Link href='/market'><button className='bg-orange-600 font-bold text-black w-40 p-1 rounded-md'>MARKET</button></Link>
    </div>
    </div>
    </>
  )
